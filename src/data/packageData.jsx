export const packagePosts = [
  {
    id: 1,
    slug: "kashmir-tour-packages-customized-trips-holidays",
    metatitle:
      "",
    metadescription:
      "",
    ...
    image: "/Package/kashmir/Kashmir Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Domestic Kashmir Guide.pdf.pdf",
    tags: [
      "Travel Agency",
      "Holiday Packages",
      "International Tours",
    ...
    excerpt:
      "If there is paradise on earth, it is here, it is here, it is here - Amir Khusrau captured exactly what millions of visitors discover about Kashmir each year.",
    relatedPosts: [2, 3],

    hero: {
      title: "Kashmir Tour Packages - Customized Trips & Holidays",
      subtitle:
        "If there is paradise on earth, it is here, it is here, it is here.....",
      coverImage:
        "/Package/banner/Kashmir Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
    ...
    overview:
      `
        <p class="mt-5">
       Kashmir is an internationally-recognized breathtaking tourist destination. Amir Khusro stated it best, "If there is paradise on earth, it is here, it is here, it is here."
        </p>
        <p class="mt-5">
     Kashmir is lined with its surreal, alluring snow capped mountains and its sparkling lakes. So, Kashmir deserves its title as "Paradise on Earth." It's wonderful rushing nature and charming culture invites you. We have created amazing Kashmir travel packages to guarantee best adventures and ways to leave you with memories that you will cherish.
        </p>
        <p class="mt-5">
     This could be the getaway you have only dreamed of. Our packages picture you waking up on a houseboat, skiing the glorious, snowy mountains of Gulmarg or walking the wild flower filled meadows of Pahalgam. We have the most exhilarating and stressing tours for every kind of traveler from luxury travelers to families and honeymooners.
        </p>
        <p class="mt-5">
       We have customized Kashmir travel packages with something for everyone. We have everything from a high end, stress free vacation to a budget friendly, highly adventurous vacation. We have the package perfected with all the travel essentials including lodging and flights. You get to enjoy everything from scenic views and delightful activities.
        </p>
        <p class="mt-5">
       Experience the breathtaking beauty that has long inspired poets around the world! Explore and discover the reasons that have made Kashmir one of the world's most talked about places!
        </p>
        `,

    gallery: [
      "/Package/kashmir/Kashmir Image 1 (250x200).jpg.jpeg",
      "/Package/kashmir/Kashmir Image 2 (250x200).jpg.jpeg",
      "/Package/kashmir/Kashmir Image 3 (250x200).jpg.jpeg"
    ],
  ...
  {
    id: 2,
    slug: "himachal-pradesh-tour-packages-customized-holiday-trips",
    metatitle:
      "",
    metadescription:
      "",
    ...
    image: "/Package/himachal/Himachal Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Himachal Domestic Guide.pdf.pdf",
    ...
    excerpt:
      "Planning a holiday in the hills? You are at the right place. Himachal Pradesh is one of those rare places that fits every kind of traveler—whether you're chasing snow, looking for spiritual calm, or just want to sip chai with a view.",

    relatedPosts: [2, 3],

    hero: {
      title: "Himachal Pradesh Tour Packages - Customized Holiday Trips",
      subtitle:
        "Planning a holiday in the hills?...",
      coverImage:
        "/Package/banner/Himachal Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
    ...
    overview:
      `
        <p>
      Planning a hilly getaway? Welcome! Himachal Pradesh caters to all kinds of travelers. Whether you enjoy snow, seek spiritual rejuvenation, or love sipping chai with a view, you are most welcome!
        </p>
        <p class="mt-5">
  With so much variety Himachal tour packages are really useful to keep itineraries enjoyable and memorable.
        </p>
        <p class="mt-5">
   At RisezonicTravel we hand craft tour packages to Himachal based on your pace, preferences, and point of departure. We also cover transportation, packing tips, permits, local culture, and stays and activities a bit off the beaten path when you come to us for a short getaway, a family trip, or a complete Himachal tour package from Delhi, Chandigarh, and surrounding cities. Don’t settle for a one size fits all tour package
        </p>
        <p class="mt-5">
    We take pride in creating entertaining, unique, and flexible, tour packages to Himachal Pradesh.
        </p>
        `,

    gallery: [
      "/Package/himachal/Himachal Image 1 (250x200).jpg.jpeg",
      "/Package/himachal/Himachal Image 2 (250x200).jpg.jpeg",
      "/Package/himachal/Himachal Image 3 (250x200).jpg.jpeg"
    ],
...

  {
    ...
    image: "/Package/kerala/Kerala Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Domestic Kerala Guide.pdf.pdf",
    ...
    excerpt:
      "Ever dreamed of a destination where misty mountains embrace the sea, and time slows to nature’s serene rhythm? Welcome to Kerala, God's Own Country.",
    ...
    hero: {
      ...
      subtitle:
        "Ever dreamed of a destination where misty mountains embrace the sea...",
      coverImage:
        "/Package/banner/Kerala Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
    ...
    overview:
      `
        <p>
     Imagine a place where the lakes and mountains intertwine and the hustle and bustle of the city is replaced with harmony and tranquility. That is Kerala; God's Own Country.
        </p>
        <p class="mt-5">
    Words do not do Kerala justice. The misty tea plantations, the towering coconut trees and an infinite amount of other sights, sounds, and feelings that come together to offer an experience like no other. The wilderness of Thekkady, the views from Munnar, and all the other places that Kerala has to offer are waiting to create memories with you.

        </p>
        <p class="mt-5">
  Alleppey is one of the most magical places in all of Kerala, and it is just a single stop on our all-inclusive tour package. The houseboats are a great place for a romantic getaway, a vacation, and an all-in-one family adventure. Kerala also has the calming Indian traditional Kathakali performances, Ayurvedic medicines and treatments, and the thundering waterfalls of the Western Ghats.

        </p>
        <p class="mt-5">
  There are spice plantations and wildlife safaris for the adventurous spirit. The sunbathed beaches and calm hill stations for the nature lovers also offer countless family activities.
        </p>
        <p class="mt-5">
       Now that you have an idea for the place to make memories, make them in Kerala. The beautiful place that will calm you while also spicing up your memories.
        </p>
        <h2 class="text-2xl mt-5 font-semibold">Enjoy Your Getaway with RisezonicTravel</h2>
        
        <p class="mt-5">
        <b>Ideal Months of Travel:</b> October to March (Post-Monsoon & Winter), June to September (Monsoon), April to June (Summer Hill Retreats)
        ...
        <li class="mt-5">
        <b>Munnar –</b> Tea gardens and waterfalls in the mist

        </li>
<li class="mt-5">
<b>Alleppey –</b> Enchanting houseboats in the backwaters


</li>
<li class="mt-5"><b>Thekkady –</b>Spice plantations and wildlife
</li>
<li class="mt-5"><b>Kovalam –</b>Ayurvedic spas and beaches
</li>
        </ul>

        <p class="mt-5">
        <b>Signature Dishes:</b> Kerala Sadya, Appam with Stew, Puttu & Kadala, Karimeen Pollichathu, and Banana Chips</p>
        `,

    gallery: [
      "/Package/kerala/Kerala Image 1 (250x200).jpg.jpeg",
      "/Package/kerala/Kerala Image 2 (250x200).jpg.jpeg",
      "/Package/kerala/Kerala Image 3 (250x200).jpg.jpeg"
    ],
...

  {
    ...
    image: "/Package/goa/Goa Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Goa Domestic Guide.pdf.pdf",
    ...
    excerpt:
      "Goa is one of India’s most popular holiday destinations, known for its sun-kissed beaches, vibrant nightlife, Portuguese heritage, scenic landscapes, and relaxed coastal atmosphere.",
    ...
    hero: {
      ...
      subtitle:
        "Ever dreamed of a destination where misty mountains embrace the sea...",
      coverImage:
        "/Package/banner/Goa Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
    ...
    overview:
      `
        <p>
   Goa is one of the busiest tourist locations in India, and for good reason. It has everything you could want on a holiday - beaches, culture, natural scenery, nightlife, and a more relaxed vibe. There are beach shacks, watersports, historical sites, and nice quiet retreats. It all makes Goa a place to cater for any type of tourist.
        </p>
        <p class="mt-5">
    Goa is split into North and South, where North is known for its party scene and South is more relaxed and laid back. You can experience both in one trip. You can enjoy the well known beaches, take a river cruise, see old architecture, visit waterfalls, and shop in local markets to eat mouth watering food.
        </p>
        <p class="mt-5">
The focus of our Goa trip plans is to give tourists an experience that is both comfortable and stress free. Choose from beach breaks, luxury get aways and more in our family, romantic and individual holiday plans that all differ in budget. Stress free accommodation and plans that focus on memorable Goa attractions and experiences are all included in our trip plans.

        </p>

        <p class="mt-5">
 Beyond all the nightlife and beach parties that Goa is known for, our Goa trip plans are a unique experience. Choose from a heritage tour of Old Goa, exploration of the villages and hidden beaches or cultural and culinary experiences. Relaxation and sightseeing are mixed perfectly in our trip plans.
        </p>

      <h2 class="mt-5 font-semibold">Goa Overview</h2>
      <ul class="pl-6 lisc-disc">
      
      <li class="mt-5">
      <b>Region:</b>  Western India, along the Arabian Sea
      </li>
      <li class="mt-5">
      <b>Goa is Known For:</b> Its beaches, nightlife, water sports, churches, seafood, and festivals
      </li>
      <li class="mt-5">
      <b>Ideal Travel Time:</b>1st October - 31st March
      </li>
      <li class="mt-5">
      <b>Recommended Duration: </b> 3–6 Days
      </li>
      <li class="mt-5">
      <b>Must Visit:</b>North and South Goa, Panaji, Old Goa, Dudhsagar Falls
      </li>
      <li class="mt-5">
      <b>Common Activities: </b> Water sports, cruises, shopping, nightlife, sightseeing, beach hopping
      </li>
      <li class="mt-5">
      <b>Good for:</b> Families, Couples, Solo, and Honeymooners

      </li>
      </ul>

      <p clas="mt-5">
     Getaway Packages to Goa at the Beach.
      </p>
...

  {
    ...
    image: "/Package/bali/Bali Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Bali Guide.pdf.pdf",
    ...
    excerpt:
      "Bali has many great elements that draw Indian tourists again and again. Tourists find sandy beaches, a rich culture, and the adventure of being on an island.",
    relatedPosts: [2, 3],

    hero: {
      title: "Bali Tour Packages",
      subtitle:
        "Bali has many great elements that draw Indian tourists again and again......",
      coverImage:
        "/Package/bali/Bali Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
    ...
    overview:
      `
      <p class="mt-5">
    Bali has many great elements that draw Indian tourists again and again. Tourists find sandy beaches, a rich culture, and the adventure of being on an island. Variety in the Indian tour packages to Bali allows tourists to experience Bali in many ways based on one’s money, convenience, and time.
      </p>

    <p class="mt-5">
    Every Bali trip guarantees a combination of leisure and fun, sightseeing in Ubud, sunset at Tanah Lot temple, and enjoying the beaches of Kuta and Seminyak. Traveling to Bali gives opportunity for a day trip to the islands of Nusa Penida, or engaging in a number of water-based activities such as snorkeling and diving. Bali travel packages cater for fun and adventure for families and couples, as well as a great honeymoon.
    </p>

      <p class="mt-5">
      Of popular Indian Bali packages, the best feature is flexibility. Bali tour packages lack a prescribed itinerary and allow a great selection of hotels, as well as a great selection of activities. These customizable holiday packages from India provide the best opportunity to plan your own honeymoon, family holiday, or leisure trip, based on how you want to spend your time.
      </p>

      <h2 class="mt-5 font-semibold">Planning your Bali Trip: The Basics</h2>
      <h2 class="mt-5 font-semibold">Some basic info for your planning:</h2>
      <p class="mt-5">
      ...
      <li>
      <b>When to go:</b> April - October (see our best time to visit Bali guide for details on special trips and seasonal changes)
      </li>
      <li><b>Visa for Indians:</b> Visa on Arrival (VoA) approx. IDR 500,000 / ₹2,700 (Visit our bali visa guide for indians for documents, process, and more)</li>

      <li>
      <b>Closest Airport: </b>Ngurah Rai International Airport (Denpasar - DPS) with direct flights from Delhi and Mumbai.
      </li>

      <li>
      <b>Trip Duration:</b> 5 - 7 Days.
      </li>

      <li>
      <b>Local Currency: </b>Indonesian Rupiah (IDR)
      </li>

      <li>
      <b>Time Zone:</b> 2.5 hours ahead of India (IST).
      </li>

      <li><b>Language: </b>Indonesian with Balinese spoken, but English is common in tourist areas.</li>

      <li>
      <b>Must See:</b> Ubud, Nusa Penida, Seminyak, Kuta, Gili Islands.
      </li>

      <li>
      <b>Ideal Travel Groups:</b> Honeymoon, couples, family.
      </li>
      </ul>

      <p class="mt-5">
Choose your Bali tour packages and plan your trip based on your travel preferences.
      </p>
    ...
    gallery: [
      "/Package/bali/Bali Image 1 (250x200).jpg.jpeg",
      "/Package/bali/Bali Image 2 (250x200).jpg.jpeg",
      "/Package/bali/Bali Image 3 (250x200).jpg.jpeg"
    ],
...

  {
    ...
    categories: ["Worldwide Honeymoon", "International Tours"],
    authorAvatar: "/images/Logo/risezoniclogo.png",
    ...
    image: "/Package/vietnam/Vietnam Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Vietnam Travel Guide.pdf.pdf",
    ...
    excerpt:
      "Vietnam is one of Southeast Asia's most captivating travel destinations, known for its dramatic landscapes, vibrant cities, rich history, and incredible food culture. Our Vietnam tour packages from India take you across the country's most iconic destinations through carefully planned itineraries with guided sightseeing and comfortable stays.",
    relatedPosts: [2, 3],

    hero: {
      title: "Vietnam Tour Packages",
      subtitle:
        "Vietnam is one of Southeast Asia's most captivating travel destinations, known....",
      coverImage:
        "/Package/vietnam/Vietnam Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
   ...
   Vietnam is one of Southeast Asia's most captivating travel destinations, known for its dramatic landscapes, vibrant cities, rich history, and incredible food culture. Our Vietnam tour packages from India take you across the country's most iconic destinations through carefully planned itineraries with guided sightseeing and comfortable stays.
    ...
    <p class="mt-5">
 From the bustling streets of Hanoi and the historic town of Hoi An to the modern city of Ho Chi Minh City, every region of Vietnam offers a different experience. Travellers can cruise through the limestone islands of Halong Bay, relax on the beaches of Phu Quoc, explore cultural landmarks, and discover the country's diverse food culture.
    </p>

      <p class="mt-5">
   Whether you're looking for a short getaway or a multi-city holiday, our Vietnam trip packages are designed to help you explore North, Central, and South Vietnam with seamless travel planning, comfortable accommodations, and expert on-ground support.

      </p>

      <h2 class="mt-5 font-semibold">Vietnam Tourism: At a Glance</h2>
      <h2 class="mt-5 font-semibold">Before planning your Vietnam trip, here are a few essential travel details every traveller should know.</h2>
      <p class="mt-5">
      Capital City: Hanoi
      </p>
      ...
      <ul class="pl-6 list-disc">
      <li>
      <b>Currency:</b> Vietnamese Dong (VND) – approx. 1 INR ≈ 280–300 VND (Exchange rates may vary)

      </li>
      <li><b>Time Zone:</b>GMT+7 (1.5 hours ahead of IST)
 </li>

      <li>
      <b>Language: </b>Vietnamese (English is commonly spoken in major tourist areas.)
      </li>

      <li>
      <b>Visa for Indians:</b>Indian travellers can apply for a Vietnam e-Visa online (valid for up to 90 days).

      </li>

      <li>
      <b>Best Time to Visit: </b>October to April offers pleasant weather across most regions

      </li>

      <li>
      <b>Flight Duration from India:</b> 4 to 6 hours (direct flights from Delhi, Mumbai & Kolkata)
      </li>

      <li><b>Ideal Trip Duration:</b>5 to 10 days to cover major destinations across North, Central and South Vietnam
</li>

      </ul>

      <p class="mt-5">
Explore our Vietnam tour packages from below covering North, Central, and South Vietnam, with expertly planned itineraries, expert on-ground support, and transparent pricing.
      </p>
        `,

    gallery: [
      "/Package/vietnam/Vietnam Image 1 (250x200).jpg.jpeg",
      "/Package/vietnam/Vietnam Image 2 (250x200).jpg.jpeg",
      "/Package/vietnam/Vietnam Image 3 (250x200).jpg.jpeg"
    ],
...

  {
    ...
    image: "/Package/singapore/Singapore Banner Image (750x380).jpg.jpeg",
    pdf: "/pdf/Singapore Travel Guide.pdf.pdf",
    ...
    excerpt:
      "It's no wonder why tour packages from India to Singapore are in such high demand. Located at the southern tip of the Malay Peninsula, Singapore boasts a seamless blend of modern urban infrastructure and cultural neighborhoods. It has plenty of amazing attractions like Universal Studios, Sentosa Island, and Gardens by the Bay, and everything is easy to navigate within the city.",
    relatedPosts: [2, 3],

    hero: {
      title: "Singapore Tour Packages",
      subtitle:
        "It's no wonder why tour packages from India to Singapore are in such high demand.....",
      coverImage:
        "/Package/singapore/Singapore Banner Image (750x380).jpg.jpeg",
      rating: 4.9,
      reviews: 120,
    },
  ...
  It's no wonder why tour packages from India to Singapore are in such high demand. Located at the southern tip of the Malay Peninsula, Singapore boasts a seamless blend of modern urban infrastructure and cultural neighborhoods. It has plenty of amazing attractions like Universal Studios, Sentosa Island, and Gardens by the Bay, and everything is easy to navigate within the city.
    ...
    <p class="mt-5">
For many first time travelers to Singapore from India, it's a good option because there are multiple flight options from India, and Singapore has a huge Indian population. You won't feel too out of place with Little India (neighborhood) being a major Singapore tourist sink.
    </p>
...
<p class="mt-5">
Here are some facts for travelers to consider before making the trip to Singapore:
</p>

<ul class="pl-6 list-disc mt-5" >
    <li>
    <b>City:</b> Singapore (City-State)
    </li>

    <li>
    <b>Currency: </b>Singapore Dollar (SGD) (Approx. 1 SGD = 73 INR)
    </li>
    <li>
    <b>Time Zone:</b> GMT +8 (2 hours and 30 mins ahead of India)
    </li>

    <li>
    <b>Visa for Indians:</b> Singapore e-Visa (e-Visa for Singapore is to be applied through entitlement agents for a fee, and applicants must ensure the agents are legitimate. Processing time is between 3 - 5 working days)
    </li>

    <li>
    <b>Best Time to Visit:</b> February to March (Least rain, more sun) and June to July (Family vacation period)
    </li>

    <li>
    <b>Flight Duration from India:</b> 4.5 to 6 hours (Most major Indian cities have direct flights)
    </li>

    <li>
    <b>Typical Trip Duration:</b> 4 to 6 days (This is usually enough time to visit all the major attractions including Mandai Wildlife Reserve, Marina Bay, and Sentosa)
    </li>

    <p class="mt-5">
    There’s no denying that most travelers underestimate how complicated planning a trip to Singapore can be. At RisezonicTravel, you don’t have to worry about anything. We provide personalized options for Singapore vacation packages from India, based on your travel dates, budget, and the type of experience you want.
    </p>

    <p class="mt-5">
    We understand that travel preferences differ. That’s why we strive to make our trips flexible for families, couples, and more. There are no standard packages. For your next family trip, your perfect getaway, or a honeymoon to remember, we will ensure you get to see the attractions of your preference, in the time you have available, and with the travel style most comfortable to you.
    </p>

    <p class="mt-5">
    Our multiple options also ensure you can get the ideal trip to Singapore from India. Our flexible on-site professionals and fair pricing support help you to choose the optimal travel package, so you have a fabulous trip. Browse through our Singapore packages below, and contact us for further assistance.
    </p>
</ul>
    ...
    gallery: [
      "/Package/singapore/Singapore Image 1 (250x200).jpg.jpeg",
      "/Package/singapore/Singapore Image 2 (250x200).jpg.jpeg",
      "/Package/singapore/Singapore Image 3 (250x200).jpg.jpeg"
    ],
...

  {
    ...
    excerpt:
      "What does it really mean to indulge? Perhaps it means having the ability to put the mind at ease and disengage from the demands of time. The Maldives is a country that represents the concept of relaxation, ",
    relatedPosts: [2, 3],

    hero: {
      title: "Maldives Tour Packages",
      subtitle:
        "What does it really mean to indulge? Perhaps it means having the ability to put the mind at ease and disengage from the demands of time. ",
      coverImage:
        "",
      rating: 4.9,
      reviews: 120,
    ...
    overview:
      `
      <p class="mt-5">
      What does it really mean to indulge? Perhaps it means having the ability to put the mind at ease and disengage from the demands of time. The Maldives is a country that represents the concept of relaxation, and we have the ultimate way for you to experience it with our Maldives tour package.
      </p>
      <p class="mt-5">
      The Maldives consists of 1,192 islands and 26 Atolls in the Indian Ocean. The Maldives is 1 of the lowest countries in the world, averaging only 1.5 meters above sea level. The Maldives is properly named, as it has almost all the colors of the mallet with the warm, clear waters, coral, and white-sanded reefs. It is one of the most popular island destinations.
      </p>

      <p class="mt-5">
      At RisezonicTravel, we design Maldives tour packages from India, based on your preferences, style, and your budget. It could be a honeymoon tour for a couple, a family therapeutic tour or a tour filled with shenanigans and adventures for a group of friends. Everything is based on your travel dates and your preferred resort with all the activities you want, fitting your budget.
      </p>

      <p class="mt-5">
      Our Maldives packages are a great way to start planning your island holiday.
      </p>

      <h4 class="text-2xl font-semibold">An Overview of the Maldives:</h4>
      <ul class="pl-6 mt-5 list-disc">
      <li>Currency: Maldivian Rufiyaa (MVR)</li>
      <li>Capital: Malé</li>
      <li>Language: Dhivehi (English is widely spoken)</li>
      <li>Time Zone: Maldives Time (MVT), UTC +5</li>
      </ul>
      <p class="mt-5">
      Visa for Indians: Free visa-on-arrival for 30 days (with the conditions of a valid passport, confirmed accommodation, sufficient funds, an onward/return ticket). The Indian traveller is required to submit the IMUGA (Traveller Declaration) form, prior to the intended travel, within 96 hrs of landing in the Maldives.
      </p>

      <ul class="mt-5 pl-6 list-disc">
      <li>When to Go: November to April</li>
      <li>Bengaluru to Malé: ~2 hours</li>
      <li>MFB to Malé: ~2.5 hours</li>
      <li>Delhi to Malé: ~4.5 to 5 hours</li>
      <li>International Airport: Velana International Airport (Malé)</li>
      <li>Traveling Time: 4 to 6 days</li>
      </ul>
...

  {
    ...
    excerpt:
      "Thailand has become a popular destination for Indian travellers for good reason. Try to find a better destination that offers tropical islands, great shopping, delicious food, and a big party scene. ",
    relatedPosts: [2, 3],
    ...
    overview:
      `
      <p class="mt-5">
   Thailand has become a popular destination for Indian travellers for good reason. Try to find a better destination that offers tropical islands, great shopping, delicious food, and a big party scene. There are enough sites and activities in Thailand to satisfy a wide variety of travellers. There are the bustling streets of Bangkok, the nightlife of Pattaya, and the beautiful beaches of Phuket and Krabi.
      </p>
      <p class="mt-5">
     Thailand has so much to offer and our holiday packages have the perfect stay and itineraries to help you see the best of Thailand.
      </p>

      <p class="mt-5">
    Our packages include Bangkok and Phuket, Krabi and Pattaya, and the Phi Phi Islands and surrounding areas. You’ll be able to visit the numerous temples, participate in beach activities and island tours, shop at local markets, and enjoy the nightlife.
      </p>

      <p class="mt-5">
     Travellers enjoy the quick flights and easy itineraries, which is why Thailand is the top international destination for Indian travellers. Thailand packages typically include a 5 to 7 day itinerary with the perfect balance of sightseeing and beach relaxation with plenty of time to explore the numerous coastal and island sites.
      </p>

      <h4 class="text-2xl font-semibold">Thailand at a Glance</h4>
      <ul class="pl-6 mt-5 list-disc">
      <li>Best Time to Visit: November to April for the best weather.</li>
      <li>Ideal Trip Duration: 5-7 days</li>
      <li>Visa: Visa-free / Visa on Arrival (check latest updates)</li>
      <li>Currency: Thai Baht (THB)</li>
      <li>Top Activities: Beaches, nightlife, island hopping, temple tours, cultural markets.</li>
      </ul>
      <p class="mt-5">
     We offer Thailand holiday packages that cater to honeymooners, families, and friends alike. Browse Thailand tour packages and select the one that fits your requirements. Reading practical travel tips for Thailand may help prepare you for your trip.
      </p>

      <ul class="mt-5 pl-6 list-disc">
      <li>Travel Guide</li>
      <li>Couple relaxing on Krabi beach with limestone rock</li>
      <li>Aerial view of Maya Bay limestone islands and lagoon</li>
      <li>Longtail boats at Phi Phi Island tropical beach</li>
      </ul>
        `,
...

  {
    ...
    categories: ["International Tours"],
    authorAvatar: "/images/Logo/risezoniclogo.png",
    ...
    excerpt:
      "An amazing invitation to a beautiful country is now at your fingertips. Experience the happiness in Bhutan. Enter the dragon's land and let your spirit to be uplifted by the mysteries at the enchanted land. Our Bhutan tour packages will bring to you the happiest place on earth with the beautiful landscapes and the peace you are searching for.",
    relatedPosts: [2, 3],

    hero: {
      title: "Bhutan Tour Packages - Plan Your Perfect Bhutan Trip",
      subtitle:
   ...
   Exhilarating isn't it? What could be better than a quick getaway to the happiest country on the planet?
      ...
      <p class="mt-5">
    An amazing invitation to a beautiful country is now at your fingertips. Experience the happiness in Bhutan. Enter the dragon's land and let your spirit to be uplifted by the mysteries at the enchanted land. Our Bhutan tour packages will bring to you the happiest place on earth with the beautiful landscapes and the peace you are searching for. Our tour packages will accommodate all sorts of travelers, so whether you are a dreamer, a romantic, an adventurer, or you want to bring your kids to Bhutan for a family trip, you will all be accommodated. Our tours will bring the happiest place on earth to you in a combination of luxurious and affordable trips.
      </p>

      <p class="mt-5">
   RisezonicTravel has a plan for you if you want to customize your Bhutan tour package. Plan a trip from India to Bhutan or see what a couple's or family's trip to Bhutan would cost. The options are endless. Don't wait any longer! A journey to explore the happiest place on earth, Bhutan, now awaits you.
      </p>
        `,
...

  {
    ...
    excerpt:
      "Sri Lanka intersects with crashing waves and ancient relics. Picture a morning of ocean side slumbers interrupted by a fresh cup of Ceylon tea.",
    relatedPosts: [2, 3],

    hero: {
      title: "Sri Lanka Tour Packages - Customizable Tour Packages & Trips",
      subtitle:
  ...
  Take a trip through coastline and culture.
      ...
      <p class="mt-5">
   Sri Lanka intersects with crashing waves and ancient relics. Picture a morning of ocean side slumbers interrupted by a fresh cup of Ceylon tea. Enjoy a brisk hike up Sigiriya and unwind without a worry amidst the tropical vegetation.
      </p>

      <p class="mt-5">
 Tailor your holiday with Style Adventures Sri Lanka tour packages. Choose between beach, culture, and tea, or any combination of the three. From the nature of Kandy, the chill of Nuwara Eliya, the beach of Bentota, and the city of Colombo, our Sri Lanka tour package for family and Sri Lanka tour package for couples includes the best of all worlds and the most diverse getaway.

      </p>
      <p class="mt-5">
      What about the cost for a Sri Lanka trip? There is a package to meet every budget.
      </p>
      <p class="mt-5">
      The chance to create your own Sri Lankan tale is finally here. Is it too good to be true?
      </p>
        `,
...

  {
    ...
    excerpt:
      "Impressive skylines? Rainforests? Delicious food? We've got it all in our Malaysia tour packages! Malaysia is a great holiday locale for families,..",
    relatedPosts: [2, 3],

    hero: {
      title: "Malaysia Tour Packages - Customizable Tour Packages & Trips",
      subtitle:
    ...
    overview:
      `
      <p class="mt-5">
 Impressive skylines? Rainforests? Delicious food? We've got it all in our Malaysia tour packages! Malaysia is a great holiday locale for families, couples, newlyweds, and even solo travelers, making it a fun and popular vacation choice.
      </p>
      <p class="mt-5">
 Diverse, modern, and budget friendly, it’s no mystery why India travelers are in love with Malaysia.
      </p>
...
Malaysia at a Glance:
      ...
      <p class="mt-5">
     A little information on Malaysia before you make the journey:
      </p>
      <ul class="pl-6 mt-5 list-disc">
      <li>Capital City: Kuala Lumpur</li>
      <li>Currency: Malaysian Ringgit (MYR) - (approx.) 1 INR ≈ 0.10 MYR / 1 MYR ≈ 24 INR</li>
      <li>Time Zone: GMT+ 8 (2 hrs 30 mins ahead of India)</li>
      <li>Visa for Indians: 30 days tourist visa is free / Visa on arrival</li>
      <li>Best Time to Visit: November - February (dry, pleasant) or March - May (fewer tourists, good weather)</li>
      <li>Flight Duration from India: 4.5 - 6.5 hours (Direct flights) from Delhi, Mumbai, Chennai, Bengaluru, Kolkata, Hyderabad, and Kochi
</li>
<li>
Ideal Trip Duration: 4 - 8 days (Kuala Lumpur, Genting Highlands, Langkawi). Cover major highlights and travel comfortably.</li>
      </ul>
      <p class="mt-5">
      RisezonicTravel provides tailored tour packages to Malaysia from India based on your holiday style. We create personal honeymoon packages for Malaysia, and family vacation packages with the preferences of every family member in order to include everyone.
      </p>
        `,
